...
const index = () => {
    ...
    return (
        <ApSafeAreaView>
            <ApHeaderTitle title="Services" caption="The Best  Services You Can Get" />
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'center', gap: 10, flexWrap: 'wrap' }}>
                    {
                        quickAction.map((a, index) => (
                            <TouchableOpacity key={index} onPress={() => {
                                ...
                                <View style={{ borderWidth: 2, width: 105, justifyContent: "center", height: 100, borderRadius: 10, borderColor: "#362756" }}>
